...
namespace fs
{
    public class CreateAudioSoundScript
    {
        //会导致在Unity编辑器下右键文件夹比较慢，先注释
        //[MenuItem("Assets/自动创建AudioSoundAsset脚本", true)]
        //private static bool IsShowCreateScript()
        //{
        //    Object[] select_objs = Selection.objects;
        //    if (select_objs == null || select_objs.Length != 1)
        //        return false;
        //    Object[] all_objs = Selection.GetFiltered(typeof(AudioSoundData), SelectionMode.DeepAssets);
        //    if (all_objs == null || all_objs.Length == 0) return false;
        //    return true;
        //}

        [MenuItem("Assets/自动创建AudioSoundAsset脚本", false)]
        private static void CreateScript()
        {
            ...
            for(int i = 0; i < all_objs.Length; ++i)
            {
                ...
                AudioSoundData data = select_obj as AudioSoundData;
        ...
        private static void CreateScript(string folder, string name, AudioSoundData data)
        {
