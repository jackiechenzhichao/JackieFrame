...
namespace AntiCheat.ObscuredTypes
{
	/// <summary>
	...
	public static class ObscuredPrefs
	{
		...
		public static void ForceLockToDeviceInit()
		{
			...
			{
				Debuger.LogWarning("[ACT] ObscuredPrefs.ForceLockToDeviceInit() is called, but LockToDevice feature is already inited!");
			}
		}
#endif
		...
		private static string GetData(string key, string defaultValueRaw)
		{
			...
			else
			{
				...
				else
				{
					if (PlayerPrefs.HasKey(originalKey))
					{
						Debuger.LogWarning("[ACT] Are you trying to read data saved with regular PlayerPrefs using ObscuredPrefs (key = " + originalKey + ")?");
					}
				}
			}
