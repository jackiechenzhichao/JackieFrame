...
namespace fs
{
    ...
    public class UIGridArrangeHorizontalPage : UIGridArrangeBase
    {
        ...
        public UIGridArrangeHorizontalPage(UIGridWrapContent pGridWrapContent) : base(pGridWrapContent)
        {
        ...
        public override int GetCellsCountByViewSize()
        {
            ...
            int tTotalLine = tViewLine + UIGridArrangeBase.mExtraLine;
        ...
        public override List<int> GetNewDataIndexList()
        {
            ...
            //   Debuger.LogError("起始index = " + tStartDataIndex);
            ...
            for (int i = 0; i < tCellCount; ++i)
            {
                ...
                {
                    //     Debuger.LogError("超过的 dataindex = " + tNewDataIndex);
                    continue;
                }
                //   Debuger.LogError("i = " + i + "新的 dataindex = " + tNewDataIndex + "   tAnchorPos = " + tAnchorPos);
