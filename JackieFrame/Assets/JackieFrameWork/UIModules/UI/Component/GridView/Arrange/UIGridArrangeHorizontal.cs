...
namespace fs
{
    ...
    /// </summary>
    public class UIGridArrangeHorizontal : UIGridArrangeBase
    {
        public UIGridArrangeHorizontal(UIGridWrapContent pGridWrapContent) : base(pGridWrapContent)
        {
        }
        ...
        {
            mGridWrapContent.mScrollRectTransform.ForceUpdateRectTransforms();
